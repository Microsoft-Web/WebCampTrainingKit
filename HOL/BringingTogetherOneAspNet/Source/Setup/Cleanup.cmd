...
DEL "%MyDocuments%\Visual Studio 2013\Code Snippets\Visual C#\My Code Snippets\BringingTogetherOneAspNetEx*.snippet" 2>NUL
DEL "%MyDocuments%\Visual Studio 2013\Code Snippets\XML\My Xml Snippets\BringingTogetherOneAspNetEx*.snippet" 2>NUL
