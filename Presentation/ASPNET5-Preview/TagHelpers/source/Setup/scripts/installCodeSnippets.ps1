...
$visualStudioVersion = "Visual Studio 2015"
New-Item "$documentsFolder\$visualStudioVersion\Code Snippets" -itemtype directory -force
...
foreach ($node in $vscontent.VSContent.Content)
{
    ...
    {       
        ...
        "SQL" { $codeSnippetLocation = "$documentsFolder\$visualStudioVersion\Code Snippets\SQL\My Code Snippets" }         
